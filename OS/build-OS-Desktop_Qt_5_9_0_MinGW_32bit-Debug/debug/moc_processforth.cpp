...
QT_MOC_LITERAL(1, 13, 19), // "displayTrackNumInfo"
QT_MOC_LITERAL(2, 33, 0) // ""

    },
    "ProcessForth\0displayTrackNumInfo\0"
};
...
void ProcessForth::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ProcessForth *_t = static_cast<ProcessForth *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->displayTrackNumInfo(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject ProcessForth::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ProcessForth.data,
      qt_meta_data_ProcessForth,  qt_static_metacall, nullptr, nullptr}
};
...
void *ProcessForth::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ProcessForth.stringdata0))
        return static_cast<void*>(const_cast< ProcessForth*>(this));
